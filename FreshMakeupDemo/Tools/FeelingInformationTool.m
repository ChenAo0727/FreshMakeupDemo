...
- (instancetype)initWithBobblBrownInfomation {
    if (self = [super init]) {
        ...
        = @{@"hasTag":@"0", @"image":[UIImage imageNamed:@"feeling_BobblBrown_feeling_1.png"]};
        NSDictionary *feelingDictionary2
        = @{@"hasTag":@"0", @"image":[UIImage imageNamed:@"feeling_BobblBrown_feeling_12.png"]};
...
- (instancetype)initWithBareMineralsInformation {
    if (self = [super init]) {
        ...
        NSDictionary *feelingDictionary3 =  @{@"hasTag":@"1", @"text":@"英文全名：bareMinerals Pure Transformation Night Treatment\n Night！！！晚上用！\n 因为有VA感光成分！她好不容易挤出彩妆散粉圈，就请不要再拉她回贵圈好么！但是如果喜欢欧美国际满脸可爱小雀斑的话，不妨白天涂满全脸然后出门跟太阳来拥抱。"};
        NSDictionary *feelingDictionary4
        = @{@"hasTag":@"0", @"image":[UIImage imageNamed:@"feeling_BareMinerals_feeling_4.png"]};
        NSDictionary *feelingDictionary5 =  @{@"hasTag":@"1", @"text":@"英语烂的人，特别是看护肤品说明的时候，恨不得来台步步高点读机，哪里不会点哪里！！大意就是说：可以明显收缩毛孔，提亮肤色，加速皮肤新陈代谢，然后皮肤就会怎么怎么的亮泽，细嫩呀！（是不是感觉应该不止这么点翻译，哈哈，我百度然后简洁的总结出来的好么？）好啦，下面部分的英语是使用方法。 使用方法为：先在盖子关起来的情况下，轻轻摇晃粉盒把睡眠粉摇出来到刷子上；然后打开盖子，抖掉多余的粉，以划圈方式将粉刷在脸上。重复以上步骤2、3次以覆盖全脸。晚上在涂好所有护肤品后使用本产品。"};
        NSDictionary *feelingDictionary6
